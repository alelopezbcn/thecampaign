...
// Source: ./backend/internal/domain/ports/field.go
//
// Generated by this command:
//
//	mockgen -package mocks -source ./backend/internal/domain/ports/field.go -destination ./backend/test/mocks/field_mocks.go
//
