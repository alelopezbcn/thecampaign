...
// Source: ./internal/domain/ports/player.go
//
// Generated by this command:
//
//	mockgen -package mocks -source ./internal/domain/ports/player.go -destination ./test/mocks/player_mocks.go
//
...
func (m *MockPlayer) UseSpecialPower(warriorCard, targetCard, specialPowerCard ports.Card) error {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "UseSpecialPower", warriorCard, targetCard, specialPowerCard)
	ret0, _ := ret[0].(error)
	return ret0
}

// UseSpecialPower indicates an expected call of UseSpecialPower.
func (mr *MockPlayerMockRecorder) UseSpecialPower(warriorCard, targetCard, specialPowerCard any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "UseSpecialPower", reflect.TypeOf((*MockPlayer)(nil).UseSpecialPower), warriorCard, targetCard, specialPowerCard)
}
