...
// Source: ./backend/internal/domain/ports/castle.go
//
// Generated by this command:
//
//	mockgen -package mocks -source ./backend/internal/domain/ports/castle.go -destination ./backend/test/mocks/castle_mocks.go
//
