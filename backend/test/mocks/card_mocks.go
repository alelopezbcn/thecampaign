...
// Source: ./backend/internal/domain/ports/card.go
//
// Generated by this command:
//
//	mockgen -package mocks -source ./backend/internal/domain/ports/card.go -destination ./backend/test/mocks/card_mocks.go
//
